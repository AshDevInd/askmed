...
// Dummy order list data - Only Pending Orders
const orders = [
  {
    id: '1',
    orderNo: '200401',
...
export default function OrderListScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      />
      <CustomHeader navigation={navigation} title="Pending Orders" isHome={false} />
